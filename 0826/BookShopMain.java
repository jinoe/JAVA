...
//		BookVO vo = new BookVO();
		...
		//System.out.println(vo.title); //String은 클래스 이므로 null로 초기화
		
		
//		System.out.println(vo); //hashcode가 출력 한 클래스의 여러개의 object에 붙이는 식별번호. 16진수 8개 32비트 2^32 개
...
//		도서정보를 만든다.
		...
		BookVO book2 = new BookVO("java","홍길동","더조은출판사",new Date(2020,7,25),35000);
